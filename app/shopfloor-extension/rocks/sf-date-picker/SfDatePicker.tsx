...
import SfDatePickerMeta from "./SfDatePickerMeta";
import type { SfDatePickerRockConfig } from "./sf-date-picker-types";
import { pick } from "lodash";

export default {
  Renderer(context, props: SfDatePickerRockConfig) {
    const {} = props;
