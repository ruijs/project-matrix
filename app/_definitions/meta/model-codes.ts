export const entitySingularCodes = [
  ...
  'mom_inspection_common_characteristic',
...
const entityFieldCodes = {
  ...
  'SysExtEntityType': [
    ...
    'name',
    'description',
    'internalEntityTypeCode',
    'internalEntityExternalIdField',
    'internalEntityExternalCodeField',
    'config',
    'createdAt',
    'createdBy',
    'updatedAt',
